...
extern SDL_Color kiss_white, kiss_gray1, kiss_black, kiss_green, kiss_blue,
		kiss_lightblue, kiss_gray2;
...
extern kiss_image kiss_normal, kiss_prelight, kiss_active, kiss_bar,
	...
	kiss_hslider, kiss_sliderLine, kiss_selected, kiss_unselected, kiss_combo;
...
int kiss_array_replace(kiss_array *a, int index, double num);
