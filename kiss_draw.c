...
kiss_up, kiss_down, kiss_left, kiss_right, kiss_sliderLine, kiss_vslider,
...
SDL_Color kiss_gray1 = {48, 48, 48, 255};
SDL_Color kiss_gray2 = {34, 34, 34, 255};
...
int kiss_fillrectRenderer(SDL_Renderer *renderer, SDL_Rect *rect)
{
	if (!renderer || !rect) return -1;
	SDL_RenderFillRect(renderer, rect);
	return 0;
}
// used to define the colours of a given element...I think?
...
SDL_Renderer* kiss_init(char* title, kiss_array *a, int w, int h)
{
	...
	{
	r += kiss_font_new(&kiss_textfont, "Engine_Icons/kiss_font.ttf", a,
		kiss_textfont_size);
	r += kiss_font_new(&kiss_buttonfont, "Engine_Icons/kiss_font.ttf", a,
		kiss_buttonfont_size);
	r += kiss_image_new(&kiss_normal, "Engine_Icons/kiss_normal.png", a, renderer);
	r += kiss_image_new(&kiss_prelight, "Engine_Icons/kiss_prelight.png", a, renderer);
	r += kiss_image_new(&kiss_active, "Engine_Icons/kiss_active.png", a, renderer);
	r += kiss_image_new(&kiss_bar, "Engine_Icons/kiss_bar.png", a, renderer);
	r += kiss_image_new(&kiss_vslider, "Engine_Icons/kiss_vslider.png", a, renderer);
	r += kiss_image_new(&kiss_hslider, "Engine_Icons/kiss_hslider.png", a, renderer);
	r += kiss_image_new(&kiss_up, "Engine_Icons/kiss_up.png", a, renderer);
	r += kiss_image_new(&kiss_down, "Engine_Icons/kiss_down.png", a, renderer);
	r += kiss_image_new(&kiss_left, "Engine_Icons/kiss_left.png", a, renderer);
	r += kiss_image_new(&kiss_sliderLine, "Engine_Icons/kiss_slideline.png", a, renderer);
	r += kiss_image_new(&kiss_right, "Engine_Icons/kiss_right.png", a, renderer);
	r += kiss_image_new(&kiss_combo, "Engine_Icons/kiss_combo.png", a, renderer);
	r += kiss_image_new(&kiss_selected, "Engine_Icons/kiss_selected.png", a, renderer);
	r += kiss_image_new(&kiss_unselected, "Engine_Icons/kiss_unselected.png", a,
		renderer);
	}
	if (r) {
		kiss_clean(a);
